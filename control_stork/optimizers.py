...
class SMORMS3(optim.Optimizer):
    """
    Optimizer as described by Simon Funk
    https://sifter.org/~simon/journal/20150420.html
    """

    def __init__(self, params: Iterable, lr: float = 1e-3, eps: float = 1e-16) -> None:
        """
...
class SOAP(optim.Optimizer):
    ...
    Implementation taken from https://github.com/nikhilvyas/SOAP/blob/main/soap.py
