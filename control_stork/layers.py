# Layers module
# Julian Rossbroich, October 2021
# Justus Huebotter, 2023
...
class AbstractLayer:
    ...
    def __init__(self, name: str, model, recurrent, dalian: bool=False) -> None:
        ...
        self.model = model
        self.name = name
        self.recurrent = recurrent  # ? What is this used for?
        self.dalian = dalian
    ...
    def add_connection(self, connection, recurrent="detect", inhibitory=False) -> None:
        """
        ...
        :param recurrent:           whether connection is considered recurrent or not # ?: why can this be manually set?
    ...
    def add_neurons(self, neurons, inhibitory=False) -> None:
        """
